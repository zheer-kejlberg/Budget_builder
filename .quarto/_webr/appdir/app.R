...
serialize_posts <- function(posts_tbl) {
  posts_tbl %>%
    select(id, center, post_name, category, start_date, end_date, fte, value_mode, value_unit, 
           constant_expr, function_expr, value_vector, salary_selected, salary_field_selected, numeric_input_mode, multiply_by_fte, 
           sum_multiplier, sum_sites, sum_statuses, sum_posts, note, needs_amendment, application_status, import_issues) %>%
    mutate(
...
parse_posts <- function(posts_tbl) {
  ...
  required <- c(
    ...
    "fte", "value_mode", "value_unit", "constant_expr", "function_expr",
    "value_vector", "salary_selected", "salary_field_selected", "numeric_input_mode", "multiply_by_fte", 
    "sum_multiplier", "sum_sites", "sum_statuses", "sum_posts", "note", "needs_amendment", "application_status"
  )
